...
class Collection {
    ...
    async insertOne(document) {
        return (0, utils_1.executeOperation)(async () => {
            ...
            const resp = await this.httpClient.executeCommandWithUrl(this.httpBasePath, command, null);
            return {
                acknowledged: true,
    ...
    async deleteOne(filter, options) {
        return (0, utils_1.executeOperation)(async () => {
            ...
            const deleteOneResp = await this.httpClient.executeCommandWithUrl(this.httpBasePath, command, null);
            return {
                acknowledged: true,
    ...
    async deleteMany(filter) {
        return (0, utils_1.executeOperation)(async () => {
            ...
            const deleteManyResp = await this.httpClient.executeCommandWithUrl(this.httpBasePath, command, null);
